...
LOCATIONS = ['a0','a1','a2','a3','b0','b1','b2','b3','c0','c1','c2','c3','d0','d1','d2','d3','h0','h1','h2','h3','h4','h5','h6','h7','h8','h9','h10']
...
AMPHIPODS ={
    ...
    "A2":{ "class":"a", "targetDestination":"a0", "parked":False, "cost":1},
    "A3":{ "class":"a", "targetDestination":"a0", "parked":False, "cost":1},
    "B0":{ "class":"b", "targetDestination":"b0", "parked":False, "cost":10},
    "B1":{ "class":"b", "targetDestination":"b0", "parked":False, "cost":10},
    "B2":{ "class":"b", "targetDestination":"b0", "parked":False, "cost":10},
    "B3":{ "class":"b", "targetDestination":"b0", "parked":False, "cost":10},
    "C0":{ "class":"c", "targetDestination":"c0", "parked":False, "cost":100},
    "C1":{ "class":"c", "targetDestination":"c0", "parked":False, "cost":100},
    "C2":{ "class":"c", "targetDestination":"c0", "parked":False, "cost":100},
    "C3":{ "class":"c", "targetDestination":"c0", "parked":False, "cost":100},
    "D0":{ "class":"d", "targetDestination":"d0", "parked":False, "cost":1000},
    "D1":{ "class":"d", "targetDestination":"d0", "parked":False, "cost":1000},
    "D2":{ "class":"d", "targetDestination":"d0", "parked":False, "cost":1000},
    "D3":{ "class":"d", "targetDestination":"d0", "parked":False, "cost":1000},
}

GRAPH = {
    'a0'  : {"occupiedBy":None, "connectedTo":["a1"]},
    'a1'  : {"occupiedBy":None, "connectedTo":["a0","a2"]},
    'a2'  : {"occupiedBy":None, "connectedTo":["a1","a3"]},
    'a3'  : {"occupiedBy":None, "connectedTo":["a2","h2"]},
    'b0'  : {"occupiedBy":None, "connectedTo":["b1"]},
    'b1'  : {"occupiedBy":None, "connectedTo":["b0","b2"]},
    'b2'  : {"occupiedBy":None, "connectedTo":["b1","b3"]},
    'b3'  : {"occupiedBy":None, "connectedTo":["b2","h4"]},
    'c0'  : {"occupiedBy":None, "connectedTo":["c1"]},
    'c1'  : {"occupiedBy":None, "connectedTo":["c0","c2"]},
    'c2'  : {"occupiedBy":None, "connectedTo":["c1","c3"]},
    'c3'  : {"occupiedBy":None, "connectedTo":["c2","h6"]},
    'd0'  : {"occupiedBy":None, "connectedTo":["d1"]},
    'd1'  : {"occupiedBy":None, "connectedTo":["d0","d2"]},
    'd2'  : {"occupiedBy":None, "connectedTo":["d1","d3"]},
    'd3'  : {"occupiedBy":None, "connectedTo":["d2","h8"]},
    'h0'  : {"occupiedBy":None, "connectedTo":["h1"]},
    'h1'  : {"occupiedBy":None, "connectedTo":["h0","h2"]},
    'h2'  : {"occupiedBy":None, "connectedTo":["h1","a3","h3"]},
    'h3'  : {"occupiedBy":None, "connectedTo":["h2","h4"]},
    'h4'  : {"occupiedBy":None, "connectedTo":["h3","b3","h5"]},
    'h5'  : {"occupiedBy":None, "connectedTo":["h4","h6"]},
    'h6'  : {"occupiedBy":None, "connectedTo":["h5","c3","h7"]},
    'h7'  : {"occupiedBy":None, "connectedTo":["h6","h8"]},
    'h8'  : {"occupiedBy":None, "connectedTo":["h7","d3","h9"]},
...
def getInputData(inputFile):
    ...
    for j in range(1,-1,-1):
        for i in range(4):
            ...
            GRAPH["%s%d" % (roomClasses[i], 3 if j==1 else 0)]["occupiedBy"] = amphipodName 

    GRAPH["a2"]["occupiedBy"] = 'D2'
    GRAPH["a1"]["occupiedBy"] = 'D3'
    GRAPH["b2"]["occupiedBy"] = 'C2'
    GRAPH["b1"]["occupiedBy"] = 'B2'
    GRAPH["c2"]["occupiedBy"] = 'B3'
    GRAPH["c1"]["occupiedBy"] = 'A2'
    GRAPH["d2"]["occupiedBy"] = 'A3'
    GRAPH["d1"]["occupiedBy"] = 'C3'
...
def logGraph():
    ...
    m = matrixUtils.generate(7,11,' ')

    for i in range(11):
        m[1][i] = representOccupance('h%d' % i) 

    m[2][2] = representOccupance("a3")
    m[3][2] = representOccupance("a2")
    m[4][2] = representOccupance("a1")
    m[5][2] = representOccupance("a0")

    m[2][4] = representOccupance("b3")
    m[3][4] = representOccupance("b2")
    m[4][4] = representOccupance("b1")
    m[5][4] = representOccupance("b0")

    m[2][6] = representOccupance("c3")
    m[3][6] = representOccupance("c2")
    m[4][6] = representOccupance("c1")
    m[5][6] = representOccupance("c0")

    m[2][8] = representOccupance("d3")
    m[3][8] = representOccupance("d2")
    m[4][8] = representOccupance("d1")
    m[5][8] = representOccupance("d0")
