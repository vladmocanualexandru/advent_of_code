...
EXPECTED_RESULT = 117936

def calculateCallories(e, ingredients):
    result = e[0]*ingredients.iloc[0]["calories"]
    result += e[1]*ingredients.iloc[1]["calories"]
    result += e[2]*ingredients.iloc[2]["calories"]
    result += e[3]*ingredients.iloc[3]["calories"]
...
def solution(inputFile):
    ...
    candidatesDf["cal"] = candidatesDf.apply(lambda e: calculateCallories(e, ingredients), axis=1)

    candidatesDf = candidatesDf[candidatesDf["cal"] == 500]
