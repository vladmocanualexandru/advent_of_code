...
def getDistanceToDestination(start, stormCoordHistory, map, destinationY, destinationX):
...
def solution(inputFile):
    ...
    log(getDistanceToDestination((0,1,2), stormCoordHistory, map, len(map)-2, len(map[0])-3))    
